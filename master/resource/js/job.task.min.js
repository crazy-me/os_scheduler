...
$(document).ready(function () {
    ...
    $("#job-list").on("click", ".edit-job", function (event) {
        ...
        $("#edit-ident").val($(this).parents('tr').children(".job-ident").text());
    ...
    $("#create-job").on("click", function () {
        ...
        $("#edit-ident").val("").attr("disabled",false);
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            for (var i = 0; i < jobList.length; ++i) {
                ...
                tr.append($('<td class="job-ident">').html(job.job_ident));
...
var deleteJob = function (_this) {
    ...
    var data = {
        job_id: _element.children(".job-id").text(),
